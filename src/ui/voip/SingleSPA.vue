...
export default {
    ...
    methods: {
        ...
        setupSessionCallback() {
            ...
            sessionCallback.didChangeState = (state) => {
                console.log('spa didChangeState', state)
                this.status = state;
            ...
            sessionCallback.onInitial = (session, selfUserInfo, initiatorUserInfo, participantUserInfos) => {
                console.log('spa onInitial', session, selfUserInfo, initiatorUserInfo, participantUserInfos);
            ...
            sessionCallback.didCreateLocalVideoTrack = (stream) => {
                console.log('spa didCreateLocalVideoTrack');
                this.localStream = stream;
            };

            sessionCallback.didReceiveRemoteVideoTrack = (userId, stream) => {
                console.log('spa didReceiveRemoteVideoTrack');
                this.remoteStream = stream;
            };

            sessionCallback.didCallEndWithReason = (reason) => {
                console.log('callEndWithReason', reason, this.localStream)
                if (avenginekitproxy.useSPA){
                    this.session.forceEndMedia();
    ...
    activated() {
        console.log('spa activated');
    },

    deactivated() {
        console.log('spa deactivated');
    },
